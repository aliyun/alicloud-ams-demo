...
public class PushDemoTest extends BaseTest {
    ...
    public void testPushNoticeToAndroid_toAll() throws Exception {
        ...
        System.out.printf("RequestId: %s, ResponseId: %s, MessageId: %s\n",
                pushNoticeToAndroidResponse.getRequestId(), pushNoticeToAndroidResponse.getResponseId(), pushNoticeToAndroidResponse.getResponseId());
    }
    ...
    public void testPushMessageToAndroid_toAll() throws Exception {
        ...
        System.out.printf("RequestId: %s, ResponseId: %s, MessageId: %s\n",
                pushMessageToAndroidResponse.getRequestId(), pushMessageToAndroidResponse.getResponseId(), pushMessageToAndroidResponse.getResponseId());
    }
    ...
    public void testPushNoticeToIOS_toAll() throws Exception {
        ...
        System.out.printf("RequestId: %s, ResponseId: %s, MessageId: %s\n",
                pushNoticeToiOSResponse.getRequestId(), pushNoticeToiOSResponse.getResponseId(), pushNoticeToiOSResponse.getResponseId());
    }
    ...
    public void testPushMessageToIOS_toAll() throws Exception {
        ...
        System.out.printf("RequestId: %s, ResponseId: %s, MessageId: %s\n",
                pushMessageToiOSResponse.getRequestId(), pushMessageToiOSResponse.getResponseId(), pushMessageToiOSResponse.getResponseId());
    }
}
